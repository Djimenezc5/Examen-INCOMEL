...
namespace Proyecto_INCOMEL.Controllers
{
    ...
    {
        private INCOMELEDBContext db = new INCOMELEDBContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,FechaNacimiento,Email,Contra")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
        ...
        public bool IsValid(Login usuario)
        {
